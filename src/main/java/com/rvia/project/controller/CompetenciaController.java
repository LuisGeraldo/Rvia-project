...
import com.rvia.project.ejb.CompetenciaFacade;
...
public class CompetenciaController implements Serializable {
    ...
    @EJB
    private com.rvia.project.ejb.CompetenciaFacade ejbFacade;
    ...
    public String prepareView() {
        current = (Competencia) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CompetenciaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CompetenciaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("CompetenciaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public SelectItem[] getItemsAvailableSelectMany() {
     ...
     public SelectItem[] getItemsAvailableSelectManyFirstNone() {
        return JsfUtil.getSelectItemsFirstNone(ejbFacade.findAll(), false);
    }
